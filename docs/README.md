...
- `docs/SIM_TO_REAL_WORKFLOW.md`: firmware export, hardware replay checks, discrepancy logging, and sensitivity process.
- `docs/SIM_TO_REAL_DISCREPANCY_LOG.md`: structured template for sim-to-real issue tracking.
